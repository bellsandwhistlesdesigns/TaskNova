    ...
    <main className="bg-black text-white">
        ...
        subtitle={
          <>
            <span className="text-white">
              Modern AI-powered websites and booking systems <span className="text-yellow-400">designed to help
              salons and barber shops</span> streamline appointments, reduce missed calls, and keep
              schedules full.
            </span>
          </>
        }
      ...
      <section className="py-20 px-6 md:px-20 max-w-6xl mx-auto">
        ...
        <p className="text-gray-300 text-lg leading-relaxed text-center">
          ...
          experiences that help <span className="text-yellow-400">keep your chairs full.</span>
        </p>
      </section>
      ...
      <section className="py-24 px-6 md:px-20 bg-black text-center border-t border-yellow-500/20">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
          Ready to <span className="text-yellow-400 font-semibold">Modernize</span> Your Salon?
        </h2>

        <p className="mb-10 max-w-xl mx-auto bg-black text-gray-300">
          Let’s build an <span className="text-yellow-400 font-semibold">high-conversion digital experience salon system that helps</span> automate your bookings,
          improve your customer experiences, and <span className="text-yellow-400 font-semibold">grow your business.</span>
        </p>
